...
// Learned from https://www.youtube.com/watch?v=Zy_bCioEJhM
...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://v6.exchangerate-api.com/v6/fade2119921d587b20219425/latest/${fromCur.value}`);
